...
.Warps: db 1
	warp_def 17, 15, 1, CINNABAR_POKECENTER_1F

.CoordEvents: db 0

.BGEvents: db 4
	signpost 17, 16, SIGNPOST_READ, CinnabarIslandPokeCenterSign
	signpost 11, 13, SIGNPOST_READ, CinnabarIslandGymSign
	signpost 9, 13, SIGNPOST_READ, CinnabarIslandSign
	signpost 4, 6, SIGNPOST_ITEM, CinnabarIslandHiddenRareCandy

.ObjectEvents: db 1
	person_event SPRITE_BLUE, 6, 13, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, CinnabarIslandBlue, EVENT_BLUE_IN_CINNABAR
