...
.ObjectEvents: db 10
	...
	person_event SPRITE_COOLTRAINER_F, 18, 14, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_TRAINER, 1, TrainerCooltrainerFReika, -1
	person_event SPRITE_SIGHTSEER_F, 22, 11, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 2, TrainerSightseerFArashi, -1
	person_event SPRITE_COOLTRAINER_M, 26, 14, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_TRAINER, 2, TrainerSightseerMHyou, -1
