...
.ObjectEvents: db 8
	...
	person_event SPRITE_UMBRELLA, 24, 20, SPRITEMOVEDATA_UMBRELLA_LEFT, 0, 0, -1, -1, PAL_OW_ROCK, PERSONTYPE_SCRIPT, 0, KumquatWestUmbrellas, -1
	person_event SPRITE_UMBRELLA, 24, 21, SPRITEMOVEDATA_UMBRELLA_RIGHT, 0, 0, -1, -1, PAL_OW_ROCK, PERSONTYPE_SCRIPT, 0, KumquatWestUmbrellas, -1
	...
	person_event SPRITE_SIGHTSEER_F, 23, 24, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, KumquatWestSightseer, -1
