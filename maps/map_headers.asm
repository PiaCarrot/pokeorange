...
MapGroup11:
	map_header BattleTower1F, TILESET_BATTLE_TOWER, INDOOR, VALENCIA_ISLAND, MUSIC_BATTLE_TOWER_LOBBY, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header BattleTowerBattleRoom, TILESET_BATTLE_TOWER, INDOOR, VALENCIA_ISLAND, MUSIC_BATTLE_TOWER_THEME, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header BattleTowerElevator, TILESET_BATTLE_TOWER, INDOOR, VALENCIA_ISLAND, MUSIC_NONE, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header BattleTowerHallway, TILESET_BATTLE_TOWER, INDOOR, VALENCIA_ISLAND, MUSIC_BATTLE_TOWER_THEME, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route40BattleTowerGate, TILESET_GATE, GATE, VALENCIA_ISLAND, MUSIC_ROUTE_36, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header BattleTowerOutside, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, VALENCIA_ISLAND, MUSIC_BATTLE_TOWER_THEME, 0, PALETTE_AUTO, FISHGROUP_SHORE
