...
MapGroup15:
	map_header Route69North, TILESET_JOHTO_2, ROUTE, ROUTE_69, MUSIC_NONE, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	map_header PummeloIsland, TILESET_JOHTO_2, TOWN, PUMMELO_ISLAND, MUSIC_LILYCOVE_CITY, 0, PALETTE_AUTO, FISHGROUP_SHORE
