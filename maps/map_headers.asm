...
MapGroup9:
	...
	map_header ButwalIslandUnderwaterEast, TILESET_UNDERWATER, DUNGEON, BUTWAL_ISLAND, MUSIC_NONE, 0, PALETTE_NITE, FISHGROUP_SHORE
	map_header ButwalIslandUnderwaterWest, TILESET_UNDERWATER, DUNGEON, BUTWAL_ISLAND, MUSIC_NONE, 0, PALETTE_NITE, FISHGROUP_SHORE
