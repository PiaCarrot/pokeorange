...
MapGroup8:
	...
	map_header TrovitaIsland, TILESET_JOHTO_1, TOWN, TROVITA_ISLAND, MUSIC_GOLDENROD_CITY, 0, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map_header MayorsOfficeMeetingRoom, TILESET_POWER_PLANT, INDOOR, TROVITOPOLIS, MUSIC_ROCKET_OVERTURE, 0, PALETTE_DAY, FISHGROUP_SHORE
