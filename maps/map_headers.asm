...
MapGroup3:
	...
	map_header MtNavel1F, TILESET_CAVE, DUNGEON, MT_NAVEL, MUSIC_VICTORY_ROAD, 0, PALETTE_NITE, FISHGROUP_NONE
	map_header MtNavel2F, TILESET_ICE_PATH, DUNGEON, MT_NAVEL, MUSIC_VICTORY_ROAD, 0, PALETTE_DAY, FISHGROUP_NONE
