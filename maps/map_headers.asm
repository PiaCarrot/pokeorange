...
MapGroup9:
	map_header AscorbiaIsland, TILESET_JOHTO_1, TOWN, ASCORBIA_ISLAND, MUSIC_HOENN_DEWFORD_TOWN, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header AscorbiaIslandFanClub, TILESET_POWER_PLANT, INDOOR, ASCORBIA_ISLAND, MUSIC_HOENN_DEWFORD_TOWN, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header AscorbiaIslandMoveRelearner, TILESET_HOUSE_1, INDOOR, ASCORBIA_ISLAND, MUSIC_HOENN_DEWFORD_TOWN, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header AscorbiaIslandHouse1, TILESET_HOUSE_1, INDOOR, ASCORBIA_ISLAND, MUSIC_HOENN_DEWFORD_TOWN, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header AscorbiaIslandHouse2, TILESET_HOUSE_1, INDOOR, ASCORBIA_ISLAND, MUSIC_HOENN_DEWFORD_TOWN, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header AscorbiaIslandRoute63Gate, TILESET_GATE, GATE, ROUTE_63, MUSIC_ROUTE_36, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header AscorbiaIslandMart, TILESET_MART, INDOOR, ASCORBIA_ISLAND, MUSIC_HOENN_DEWFORD_TOWN, 0, PALETTE_DAY, FISHGROUP_SHORE
