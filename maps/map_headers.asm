...
MapGroup8:
	...
	map_header FishingContestLobby, TILESET_RADIO_TOWER, INDOOR, UNNAMED_ISLAND_2, MUSIC_BUG_CATCHING_CONTEST, 0, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup14:
	map_header PummeloIsland, TILESET_JOHTO_1, TOWN, PUMMELO_ISLAND, MUSIC_EVER_GRANDE_CITY, 0, PALETTE_AUTO, FISHGROUP_SHORE
