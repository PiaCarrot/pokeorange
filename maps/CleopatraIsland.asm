...
.ObjectEvents: db 6
	...
	person_event SPRITE_POKE_BALL, 16, 29, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, CleopatraIslandHyperPotion, EVENT_CLEOPATRA_ISLAND_HYPER_POTION
	...
	person_event SPRITE_POKE_BALL, 10, 11, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, CleopatraIslandElixer, EVENT_CLEOPATRA_ISLAND_ELIXER
	person_event SPRITE_RED, 12, 18, SPRITEMOVEDATA_STANDING_UP, 2, 2, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, CleopatraRedEvent, EVENT_RED_ON_CLEOPATRA
