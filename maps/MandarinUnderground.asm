...
MandarinUndergroundButchScript:
	...
	setevent EVENT_ROCKET_BUTCH_MANDARIN_UNDERGROUND
...
MandarinUndergroundCassidyScript:
	...
	setevent EVENT_TEAM_ROCKET_IN_MANDARIN_UNDERGROUND
	special Special_FadeInQuickly
	end
...
.ObjectEvents: db 4
	person_event SPRITE_ROCKET, 18, 17, SPRITEMOVEDATA_STANDING_LEFT, 2, 2, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, MandarinUndergroundButchScript, EVENT_ROCKET_BUTCH_MANDARIN_UNDERGROUND
