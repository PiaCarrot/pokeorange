...
.Warps: db 8
	...
	warp_def 13, 21, 1, MURCOTT_HOUSE_1
	warp_def 21, 17, 1, MURCOTT_HOUSE_2
	warp_def 25, 39, 1, MURCOTT_HOUSE_3
	warp_def 19, 29, 1, MURCOTT_POKE_CENTER
	warp_def 19, 41, 2, MURCOTT_POKE_MART
...
.ObjectEvents: db 7
	...
	person_event SPRITE_LASS, 16, 19, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, MurcottLassScript, -1
	person_event SPRITE_FRUIT_TREE, 31, 22, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, MurcottIslandFruitTree, -1
	person_event SPRITE_GRAMPS, 20, 36, SPRITEMOVEDATA_STANDING_UP, 0, 0, -2, -2, PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, MurcottOldManScript, -1
