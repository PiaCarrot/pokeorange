...
.ObjectEvents: db 7
	person_event SPRITE_CAPTURE_RING,  5, 19, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, 0, EVENT_ICE_ISLAND_CAPTURE_RINGS
	person_event SPRITE_CAPTURE_RING,  5, 17, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, 0, EVENT_ICE_ISLAND_CAPTURE_RINGS
