...
; Johto story events
	...
	const EVENT_GOT_CYNDAQUIL_FROM_IVY
	const EVENT_GOT_TOTODILE_FROM_IVY
	const EVENT_GOT_CHIKORITA_FROM_IVY
...
; Johto Signpost Items
	...
	const EVENT_MANDARIN_NORTH_SUPER_POTION ; 080
	const EVENT_081
	const EVENT_082
	const EVENT_083
...
; Johto people
	...
	const EVENT_BROCK_CRYSTAL_CAVE_1F
	...
	const EVENT_TRACEY_TANGELO_DONE
	const EVENT_TRACEY_TANGELO_VISIBLE
	const EVENT_GUIDE_GENT_IN_HIS_HOUSE
	const EVENT_GUIDE_GENT_VISIBLE_IN_CHERRYGROVE
	const EVENT_IVYS_AIDE_IN_VIOLET_POKEMON_CENTER
	const EVENT_IVYS_AIDE_IN_LAB
	const EVENT_TRACEY_LEAVING_ROUTE_56
	...
	const EVENT_FLORIA_AT_MIME__JR
...
; New to Crystal
	...
	const EVENT_TIN_TOWER_1F_TANGROWTH
