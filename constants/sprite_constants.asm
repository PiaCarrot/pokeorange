...
; sprite movement data table indices
	...
	const SPRITEMOVEDATA_MIME__JR            ; 17
	...
	const SPRITEMOVEDATA_SWIM_AROUND          ; 24
	const SPRITEMOVEDATA_SWIM_UP_DOWN         ; 25
	const SPRITEMOVEDATA_SWIM_LEFT_RIGHT      ; 26
