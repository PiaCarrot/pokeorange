	...
	tilepal 0, GRAY, BROWN, BROWN, TEXT, TEXT, TEXT, TEXT, TEXT
	tilepal 0, WATER, WATER, WATER, GREEN, GREEN, GREEN, GREEN, GREEN
	tilepal 0, GREEN, BROWN, BROWN, TEXT, TEXT, TEXT, TEXT, TEXT
	tilepal 1, WATER, WATER, WATER, GREEN, GREEN, GRAY, GRAY, GREEN
