...
; ANIM_OBJ_SIGNAL_BEAM
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_04, PAL_BATTLE_YELLOW, $15
...
; ANIM_OBJ_SEED
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_56, BATTLEANIMFUNC_2C, PAL_BATTLE_GREEN, $1d

; ANIM_OBJ_ROCK_BLAST
	battleanimobj RELATIVE_X | X_FLIP, $b8, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_02, PAL_BATTLE_BROWN, $15

; ANIM_OBJ_FALLING_BALL	
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_18, BATTLEANIMFUNC_07, PAL_BATTLE_BLUE, $08
	
; ANIM_OBJ_STICK
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_8E, BATTLEANIMFUNC_4E, PAL_BATTLE_BROWN, $1f

; ANIM_OBJ_TWINKLE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_7A, BATTLEANIMFUNC_45, PAL_BATTLE_YELLOW, $11

; ANIM_OBJ_DIVE_1
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_67, BATTLEANIMFUNC_26, PAL_BATTLE_BLUE, $1a

; ANIM_OBJ_DIVE_2
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_68, BATTLEANIMFUNC_00, PAL_BATTLE_BLUE, $1a
	
; ANIM_OBJ_P_UP_PUNCH
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_03, BATTLEANIMFUNC_00, PAL_BATTLE_RED, $01 ; ANIM_OBJ_P_UP_PUNCH
