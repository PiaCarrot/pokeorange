...
ENDM
	...
	npctrade 3, FARFETCH_D, KANGASKHAN, "MAMA@@@@@@@", $37, $66, GOLD_BERRY,   37460, "MIKE@@@@@@@", TRADE_FEMALE_ONLY
	...
	npctrade 2, HAUNTER,    AZURILL,       "PAUL@@@@@@@", $96, $86, MYSTERYBERRY, 15616, "CHRIS@@@@@@", TRADE_EITHER_GENDER
