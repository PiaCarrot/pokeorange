...
InitializeEventsScript:
	setevent EVENT_TRACEY_TANGELO_VISIBLE
	setevent EVENT_GUIDE_GENT_VISIBLE_IN_CHERRYGROVE
	setevent EVENT_IVYS_AIDE_IN_VIOLET_POKEMON_CENTER
	setevent EVENT_BROCK_CRYSTAL_CAVE_1F
	setevent EVENT_TRACEY_LEAVING_ROUTE_56
	...
	setevent EVENT_FLORIA_AT_MIME__JR
	...
	variablesprite SPRITE_WEIRD_TREE, SPRITE_MIME__JR
