...
.a:			db EKANS, ARBOK, SEAKING, ARIADOS, CROCONAW, SPINDA
			db -1
.i:			db EEVEE, GEODUDE, SPINARAK, PILOSWINE, ONIX
			db -1
.u:			db ARCANINE, MIME__JR, WEEPINBELL, VICTREEBEL, WOOPER, SWINUB
			db -1
.e:			db SKARMORY, STUNFISK, ESPEON, HITMONCHAN, ELEKID, ELECTABUZZ, ENTEI
			db -1
.o:			db FERALIGATR, PELIPPER, OCTILLERY, PRIMEAPE, WINGULL, PORYGONZ, SPEAROW, FEAROW, OMASTAR, OMANYTE
			db -1
...
.ki_gi		db SUNFLORA, CATERPIE, GYARADOS, RAPIDASH, NINETALES, GIRAFARIG, BELLOSSOM, KINGDRA, KINGLER
			db -1
.ku_gu		db GLOOM, PINECO, GLIGAR, KRABBY, WAILORD, CROBAT
			db -1
...
.ko_go		db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, KAKUNA, PSYDUCK, PHANPY, RATTATA, GOLDUCK, GOLBAT, GOLEM, GRAVELER, VENONAT
			db -1
.sa_za		db RHYHORN, MAGNEZONE, CORSOLA, HITMONLEE, ZAPDOS, JOLTEON, SANDSHREW, SANDSLASH ; RHYDON should lead this list
			db -1
.shi_ji	db SEADRA, SHELLDER, VAPOREON, DEWGONG
			db -1
.su_zu		db TANGROWTH, STARMIE, SCYTHER, ZUBAT, BEEDRILL, HYPNO, DROWZEE
			db -1
...
.tsu_du	db SHUCKLE
			db -1
.te_de		db DIGLETT, REMORAID, MANTYKE, MAGMORTAR, AMPHAROS
			db -1
.to_do		db DODUO, DODRIO, LICKILICKY, KOFFING, TENTACRUEL, TOGETIC, TOGEPI, GOLDEEN, METAPOD, DONPHAN
			db -1
...
.nu		db QUAGSIRE
			db -1
.ne		db TOGEKISS, AZURILL
			db -1
.no		db DUNSPARCE
			db -1
.ha_ba_pa	db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, BLISSEY, PARAS, PARASECT, QWILFISH, MR__MIME, TYROGUE, CLOYSTER, MARSHADOW
			db -1
.hi_bi_pi	db CLEFFA, WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, CHARMANDER, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB
			db -1
.fu_bu_pu	db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, BULBASAUR, VENUSAUR, AERODACTYL, MAGBY, IGGLYBUFF, UMBREON, ARTICUNO, JIGGLYPUFF, WAILMER
			db -1
.he_be_pe	db BAYLEEF, GRIMER, MUK, HERACROSS, ELECTIVIRE, PERSIAN, LICKITUNG
			db -1
...
.ma		db MAGCARGO, SLUGMA, QUILAVA, BELLSPROUT, WEEZING, MARILL, AZUMARILL, ELECTRODE, MANKEY, MANTINE
			db -1
.mi		db DRATINI, MEW, MEWTWO, HAPPINY
			db -1
...
.mo		db FLAAFFY, VENOMOTH, TANGELA
			db -1
.ya		db SLOWKING, SLOWBRO, SLOWPOKE, RELICANTH, YANMA
			db -1
.yu		db KADABRA
			db -1
.yo		db RHYPERIOR, NOCTOWL
			db -1
...
.ro		db VULPIX
			db -1
.wa		db JUMPLUFF, MUNCHLAX, MACHOP
.end		db -1
; 11d67e
