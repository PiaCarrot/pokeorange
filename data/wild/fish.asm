FishGroups: ; 92488
	...
	dbwwww 50 percent + 1, .Dratini_Old,          .Dratini_Good,          .Dratini_Super,		   .Dratini_Master
	dbwwww 50 percent + 1, .Qwilfish_Swarm_Old,   .Qwilfish_Swarm_Good,   .Qwilfish_Swarm_Super,   .Qwilfish_Swarm_Master
	dbwwww 50 percent + 1, .Remoraid_Swarm_Old,   .Remoraid_Swarm_Good,   .Remoraid_Swarm_Super,   .Remoraid_Swarm_Master
	dbwwww 50 percent + 1, .Gyarados_Old,         .Gyarados_Good,         .Gyarados_Super,		   .Gyarados_Master
	dbwwww 50 percent + 1, .Dratini_2_Old,        .Dratini_2_Good,        .Dratini_2_Super,        .Dratini_2_Master
	dbwwww 50 percent + 1, .WhirlIslands_Old,     .WhirlIslands_Good,     .WhirlIslands_Super,	   .WhirlIslands_Master
	dbwwww 50 percent + 1, .Qwilfish_Old,         .Qwilfish_Good,         .Qwilfish_Super,		   .Qwilfish_Master
	dbwwww 50 percent + 1, .Remoraid_Old,         .Remoraid_Good,         .Remoraid_Super,		   .Remoraid_Master
	dbwwww 50 percent + 1, .Qwilfish_NoSwarm_Old, .Qwilfish_NoSwarm_Good, .Qwilfish_NoSwarm_Super, .Qwilfish_NoSwarm_Master
