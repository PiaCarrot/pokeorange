...
HoundoomEvosAttacks: ;ELECTIVIRE
	db 0 ; no more evolutions
	db 1, LEER
	db 1, EMBER
	db 7, ROAR
...
TyranitarEvosAttacks: ;MARSHADOW
	db 0 ; no more evolutions
	db 1, BITE
	db 1, LEER
	db 1, SANDSTORM
