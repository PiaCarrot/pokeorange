...
EkansEvosAttacks:
	...
	db 25, SCREECH
	db 32, ACID
	db 37, STRUGGLE ; STOCKPILE + SPIT UP + SWALLOW
	db 43, HAZE
	db 0 ; no more level-up moves
...
ArbokEvosAttacks:
	...
	db 28, SCREECH
	db 38, ACID
	db 46, STRUGGLE ; STOCKPILE + SPIT UP + SWALLOW
	db 56, HAZE
	db 0 ; no more level-up moves
...
NidoranFEvosAttacks:
	...
	db 17, POISON_STING
	db 20, BITE
	db 23, STRUGGLE ; HELPING_HAND
	db 30, FURY_SWIPES
	db 38, STRUGGLE ; FLATTER
	db 47, CRUNCH
	db 0 ; no more level-up moves
...
NidorinaEvosAttacks:
	...
	db 18, POISON_STING
	db 22, BITE
	db 26, STRUGGLE ; HELPING_HAND
	db 34, FURY_SWIPES
	db 43, STRUGGLE ; FLATTER
	db 53, CRUNCH
	db 0 ; no more level-up moves
...
ClefairyEvosAttacks:
	...
	db 9, SING
	db 13, DOUBLESLAP
	db 17, STRUGGLE ; FOLLOW_ME
	db 21, MINIMIZE
	db 25, DEFENSE_CURL
	db 29, METRONOME
	db 33, STRUGGLE ; COSMIC_POWER
	db 37, MOONLIGHT
	db 41, LIGHT_SCREEN
	db 45, MOONBLAST
	db 0 ; no more level-up moves
...
VulpixEvosAttacks:
	...
	db 9, ROAR
	db 13, QUICK_ATTACK
	db 17, STRUGGLE ; WILL_O_WISP
	db 21, CONFUSE_RAY
	db 25, STRUGGLE ; IMPRISON
	db 29, FLAMETHROWER
	db 33, SAFEGUARD
	db 37, STRUGGLE ; GRUDGE
	db 41, FIRE_SPIN
	db 0 ; no more level-up moves
...
GrowlitheEvosAttacks:
	...
	db 7, EMBER
	db 13, LEER
	db 19, STRUGGLE ; ODOR_SLEUTH
	db 25, TAKE_DOWN
	db 31, FLAME_WHEEL
	db 37, STRUGGLE ; HELPING_HAND
	db 43, AGILITY
	db 49, FLAMETHROWER
	db 0 ; no more level-up moves
...
KadabraEvosAttacks:
	...
	db 25, RECOVER
	db 30, FUTURE_SIGHT
	db 33, STRUGGLE ; ROLE_PLAY
	db 36, PSYCHIC_M
	db 43, STRUGGLE ; TRICK
	db 0 ; no more level-up moves
...
FarfetchDEvosAttacks:
	...
	db 11, LEER
	db 16, FURY_ATTACK
	db 21, STRUGGLE ; KNOCK_OFF
	db 26, STRUGGLE ; FURY_CUTTER
	db 31, SWORDS_DANCE
	db 36, AGILITY
	db 41, SLASH
	db 46, FALSE_SWIPE
...
StaryuEvosAttacks:
	...
	db 10, RAPID_SPIN
	db 15, RECOVER
	db 19, STRUGGLE ; CAMOUFLAGE
	db 24, SWIFT
	db 28, BUBBLEBEAM
	db 33, MINIMIZE
	db 37, LIGHT_SCREEN
	db 42, STRUGGLE ; COSMIC_POWER
	db 46, HYDRO_PUMP
	db 0 ; no more level-up moves
...
OmanyteEvosAttacks:
	...
	db 13, BITE
	db 19, WATER_GUN
	db 25, STRUGGLE ; MUD_SHOT
	db 31, LEER
	db 37, PROTECT
	db 43, STRUGGLE ; TICKLE
	db 49, ANCIENTPOWER
	db 55, HYDRO_PUMP
	db 0 ; no more level-up moves
...
SunkernEvosAttacks:
	...
	db 6, GROWTH
	db 13, MEGA_DRAIN
	db 18, STRUGGLE ; INGRAIN
	db 25, STRUGGLE ; ENDEAVOR
	db 30, SUNNY_DAY
	db 37, SYNTHESIS
	db 42, GIGA_DRAIN
	db 0 ; no more level-up moves
...
SkarmoryEvosAttacks:
	...
	db 16, AGILITY
	db 26, FURY_ATTACK
	db 29, STRUGGLE ; AIR_CUTTER
	db 32, STEEL_WING
	db 42, SPIKES
	db 49, STRUGGLE ; METAL_SOUND
	db 0 ; no more level-up moves
