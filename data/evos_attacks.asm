...
RelicanthEvosAttacks: ;RELICANTH
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, HARDEN
	db 8, WATER_GUN
...
TangrowthEvosAttacks: ;TANGROWTH
	db 0 ; no more evolutions
	db 1, BITE
	db 1, LEER
	db 11, BUBBLEBEAM
...
RhyperiorEvosAttacks: ;RHYPERIOR
	db 0 ; no more evolutions
	db 1, BITE
	db 1, LEER
	db 8, SANDSTORM
...
MagnezoneEvosAttacks: ;MAGNEZONE
	db 0 ; no more evolutions
	db 1, BITE
	db 1, LEER
	db 1, SANDSTORM
