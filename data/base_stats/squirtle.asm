	...
	; tmhm
	tmhm POWERUPPUNCH, DRAGON_PULSE, WATER_PULSE, TOXIC, HAIL, WHIRLPOOL, ICE_BEAM, BLIZZARD, PROTECT, RAIN_DANCE, IRON_TAIL, RETURN, DIG, BUBBLEBEAM, DOUBLE_TEAM, FACADE, REST, SURF, STRENGTH, ROCK_SMASH, DIVE, WATERFALL, ICE_PUNCH, DYNAMICPUNCH, HEADBUTT, ZEN_HEADBUTT, COUNTER, SLEEP_TALK, SUBSTITUTE, BODY_SLAM, ATTRACT, SWAGGER, ENDURE
	; end
