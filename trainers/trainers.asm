...
; ================
	...
	db 40, MEOWTH, MALE_MASK | MEOWTH_ALOLAN_FORM
	db 40, SANDSHREW, MALE_MASK | SANDSHREW_ALOLAN_FORM
	db 40, SANDSLASH, MALE_MASK | SANDSLASH_ALOLAN_FORM
	db 40, EXEGGUTOR, MALE_MASK | EXEGGUTOR_KANTONESE_FORM
	db 40, MAROWAK, MALE_MASK | MAROWAK_KANTONESE_FORM
