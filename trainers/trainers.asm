...
; ================
	...
	db 53, MAROWAK, MALE_MASK | MAROWAK_KANTONESE_FORM
		db BONEMERANG
		db ROCK_SLIDE
		db EARTHQUAKE
		db PROTECT

	db 52, TURTONATOR, MALE_MASK
		db SHELL_TRAP
		db DRAGON_PULSE
		db FIRE_BLAST
		db NASTY_PLOT
...
; ================
	...
	db 50, MAGNEZONE, MALE_MASK
	db 50, PORYGON2, MALE_MASK
...
; ================ BUTWAL (PICK CHARMANDER)
	...
	db 40, FLAREON, MALE_MASK
		db FLAMETHROWER
		db BITE
		db QUICK_ATTACK
		db SUNNY_DAY

	db 42, SKARMORY, MALE_MASK
		db DRILL_PECK
		db AERIAL_ACE
		db SWORDS_DANCE
		db FLY
		
	db 40, TANGELA, MALE_MASK
		db ANCIENTPOWER
		db LEECH_SEED
		db GIGA_DRAIN
		db GROWTH
