...
; ================
	...
	db 100, STEELIX, LEFTOVERS, %11000000
		db IRON_TAIL
		db GIGA_IMPACT
		db DIG
		db EARTHQUAKE
...
; ================
	...
	db 44, CLEFABLE, %11110000
		db METRONOME
		db MOONBLAST
		db DOUBLESLAP
		db ATTRACT
		
	db 44, RAICHU, %11000000
		db PSYCHIC_M
		db THUNDERBOLT
		db SURF
		db SPARK
